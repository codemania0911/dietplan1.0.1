...
// select week
  $('#select_week').on('change', function() {
    ...
    link_url = link_url.concat(locale, "/showdiet/", userkey, week, week_val);
        ...
        if(response.success == true) {
          ...
          for(i=0; i < 7; i++) {
            row1 ='<li class="tab-selector nav-item">\
                  ...
                  $list1.append(row1);
            row2 = '<option value="'+i+'">'+(start_date+i)+'</option>',
                  $list2.append(row2);  
          }
          ...
          for(i=0; i<7; i++) {
            ...
            $.each(diet_plan, function() {
              var temp_recipe = 
                '<div class="media bordered diet_detail" data-recipe-id="'+(this[i].id)+'">\
...
function change() {
  if(flag == true) {
    ...
    $(".diet-slider1").stop().animate({opacity: 0.7}, 1000, function() {
      $(".diet-slider1").css("background-image", "url("+ "assets/images/slide02.jpg" +")").animate({opacity: 1},{duration:1000});
    })
    ...
    $(".diet-slider1").stop().animate({opacity: 0.9}, 2000, function(){
      $(".diet-slider1").css("background-image", "url("+ "assets/images/slide01.jpg" +")").animate({opacity: 1},{duration:2000});
    })
